...
```{css, echo=FALSE}
.kispiblue { color: #701A57; }
```

<style type="text/css">
body{ /* Normal  */ font-size: 14px; <!-- font-family: "Times New Roman", Times, serif; --> }
...
h3 { /* Header 3 */ font-size: 18px; <!-- font-family: "Times New Roman", Times, serif; -->  color: black; }
...
<div style="float: right; width: 25%;">
  <img src="../images/DALLE_guru.jpg" alt="VEP Consequences" style="width: 100%;"/>
</div>
...
Read about the ACMG classification [scoring system and protocol here](https://lawlessgenomics.com/topic/acgm-criteria-table-main).

<div style="float: center; width: 60%;">
  <img src="../images/VEP_consequences.jpg" alt="VEP Consequences" style="width: 100%;"/>
</div>
...
<div style="float: right; width: 50%;">
  <img src="../images/variant_annotation_graph.png" alt="VEP Consequences" style="width: 100%;"/>
</div>

This analysis consisted of germline short variant discovery (SNPs + Indels) using GATK v4.5.0 and interpretation using ACMGuru.
Read the full [public methods protocol page use here](http://127.0.0.1:4000/pages/design_doc/dna_germline_short.html).
...
<iframe src="../data/example_NGS000011111_NA_S23_L001_fastp.html" width="100%" height="600px" frameborder="0"></iframe>
